...
import BalanceCard1 from "../../components/BalanceCard1";
import UpdateButton from "../../components/UpdateButton";
import { UserAddress } from "../../components/Asset_API";
            ...
            {address ? (
                <Flex flexDirection={"row"}>
                    <Flex flexDirection={"column"} mr={{ base: 0, md: 8 }} p={10} mb={{ base: 4, md: 0 }}>
                        ...
                        <Tag size="lg" borderRadius="full" variant="solid" colorScheme="yellow" fontSize={{ base: "sm", md: "md" }} color={"black.500"}>{UserAddress()}</Tag>
                    </Flex>
