...
import {SCIsupply, SCItoken, RZCsupply, RZCtoken} from "../components/Asset_API";
...
//     } = useTokenSupply(CatInu);
    ...
    return (
        ...
        <Flex flexDirection={{ base: "column", md: "row" }} h={{ base: "auto", md: "50vh" }}>
            ...
            <Stack spacing={4}>
                <Heading fontSize={"xl"}>Total Circulating Supply: {RZCsupply()}</Heading>
                <Heading fontSize={"6xl"}>
                    ${RZCtoken()}
                </Heading>
                <Text fontSize={"xl"}>
                    {} is an ERC20-standardized peer-to-peer cryptocurrency, favored and circulated within Swinburne. This token is used as budget for developing the operation and infrastructure of the project!
                </Text>
                <Link href={"/transfer"}>
        ...
        <Flex flexDirection={{ base: "column-reverse", md: "row" }} h={{ base: "auto", md: "50vh" }}>
            ...
            <Flex flexDirection={"column"} justifyContent={"center"} w={{ base: "100%", md: "60%" }}>
            <Stack spacing={4}>
                <Heading fontSize={"xl"}>Total Circulating Supply: {SCIsupply()}</Heading>
                <Heading fontSize={"6xl"}>
                    ${SCItoken()}
                </Heading>
                <Text fontSize={"xl"}>
                    {} the main currency to trade for Swinburne's merchandise and vouchers. Each wallet can claim up to 100 ${} tokens. After claiming phase, this token can be topped up by achieving 'Best Performance' awards!
                </Text>
                <Link href={"/claim"}>
